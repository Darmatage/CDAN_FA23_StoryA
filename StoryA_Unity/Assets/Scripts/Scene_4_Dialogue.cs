...
public class Scene_4_Dialogue : MonoBehaviour
{
    ...
    public void Next()
    {
        ...
        else if (primeInt == 20)
        {
            ...
            Choice1c.SetActive(false); // function Choice1cFunct()
            nextButton.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "";
        ...
        else if (primeInt == 30)
        {
            ...
            Choice1a.SetActive(false); // function Choice1bFunct()
            Choice1c.SetActive(false); // function Choice1cFunct()
            nextButton.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "";
        ...
        else if (primeInt == 41)
        {
            ...
            Choice1a.SetActive(false); // function Choice1bFunct()
            Choice1b.SetActive(false); // function Choice1cFunct()
            nextButton.SetActive(true);
            Char1name.text = "";
            Char1speech.text = "";
            Char3name.text = "";
            Char3speech.text = "";
            Char4name.text = "RA";
            Char4speech.text = "You must be SISTER'S NAME'S sibling, you must be really going through alot.";
        }
        else if (primeInt == 42)
        {
            Char1name.text = "YOU";
